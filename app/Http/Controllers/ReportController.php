...
class ReportController extends Controller
{
    ...
    public function update($id, Request $request)
    {
        ...
        Job::where('id', $id)->update([
            ...
            'room_total_gov_price' => $request->get('govprice_row5a'),
            'room_indoor_area' => $request->get('govprice_row2a'),
            'room_indoor_price' => $request->get('govprice_row2b'),
            'room_balcony_area' => $request->get('govprice_row3a'),
            'room_balcony_price' => $request->get('govprice_row3b'),
            'room_parking_area' => $request->get('govprice_row4a'),
            'room_parking_price' => $request->get('govprice_row4c'),
            'room_indoor_gov_price' => $request->get('govprice_row2d'),
            'room_balcony_gov_price' => $request->get('govprice_row3d'),
            'room_parking_gov_price' => $request->get('govprice_row4d'),
