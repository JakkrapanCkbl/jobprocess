          ...
          <div class="rounded border jobs-wrap">
            ...
            <div class="job-item d-block d-md-flex align-items-center border-bottom fulltime">
              ...
              <div class="job-details h-100">
                <div class="p-3 align-self-center">
                  ...
                  <div class="d-flex row justify-content-center justify-content-md-start">
                    ...
                    <div class="mr-3"><span class="far fa-money-bill-alt text-primary"></span>&nbsp;{{number_format($job->marketvalue_unit)}} บาท / {{ $job->areaunit }} </div>
                  ...
                  <div class="d-flex row justify-content-center justify-content-md-start">
                    <div class="calendarbox">
                      ...
                      <div class="calendar">
                        <div class="dateicon">
                          <span class="vertical" id="dayofweek">{{ substr(Carbon\Carbon::parse($job->startdate)->format('l'),0,3) }}</span>
                          <h1 id="dayCaption">{{ date('d', strtotime($job->startdate)) }}</h1>
                          <h2 id="monthCaption" class="color1">{{ date('M', strtotime($job->startdate)) }}</h2>
                          <div class="over"></div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="calendarbox">
                      ...
                      <div class="calendar">
                        <div class="dateicon">
                          <span class="vertical" id="dayofweek">{{ substr(Carbon\Carbon::parse($job->inspectiondate)->format('l'),0,3) }}</span>
                          <h1 id="dayCaption">{{ date('d', strtotime($job->inspectiondate)) }}</h1>
                          <h2 id="monthCaption" class="color2">{{ date('M', strtotime($job->inspectiondate)) }}</h2>
                          <div class="over"></div>
                        </div>
                      </div>
                    </div>
                    <div class="calendarbox">
                      ...
                      <div class="calendar">
                        <div class="dateicon">
                          <span class="vertical" id="dayofweek">{{ substr(Carbon\Carbon::parse($job->lcduedate)->format('l'),0,3) }}</span>
                          <h1 id="dayCaption">{{ date('d', strtotime($job->lcduedate)) }}</h1>
                          <h2 id="monthCaption" class="color3">{{ date('M', strtotime($job->lcduedate)) }}</h2>
                          <div class="over"></div>
                        </div>
                      </div>
                    </div>
                    <div class="calendarbox">
                      ...
                      <div class="calendar">
                        <div class="dateicon">
                          <span class="vertical" id="dayofweek">{{ substr(Carbon\Carbon::parse($job->clientduedate)->format('l'),0,3) }}</span>
                          <h1 id="dayCaption">{{ date('d', strtotime($job->clientduedate)) }}</h1>
                          <h2 id="monthCaption" class="color4">{{ date('M', strtotime($job->clientduedate)) }}</h2>
                          <div class="over"></div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="job-category align-self-center">
                ...
                @elseif ($job->percentfinish >= 50 and $job->percentfinish < 100) <img src="{{ $job->ValuerAvatar }}" alt="valuer" class="brround  avatar-md w-32">
                  <img src="{{ $job->HeadAvatar }}" alt="headvaluer" class="brround  avatar-md w-32">
                  <br>
