      ...
      <div class="site-navbar bg-light">
        <div class="py-1">
          <div class="row align-items-center">
            ...
            <div class="col-2">
              <h2 class="mb-0 site-logo"><a href="/">Home
                  <!--  <strong class="font-weight-bold">Big Data</strong> -->
                </a></h2>
            </div>
            <div class="col-9">
              <nav class="site-navigation text-right" role="navigation">
                <div class="container">
                  ...
                  <ul class="site-menu js-clone-nav d-none d-lg-block">
                    ...
                    <li><a href="{{url('jobs/1234')}}"><span class="bg-primary text-white py-3 px-4 rounded">Valuer</span></a></li>
                    <li><a href="{{ route('dashboard') }}"><span class="bg-primary text-white py-3 px-4 rounded">Admin</span></a></li>
