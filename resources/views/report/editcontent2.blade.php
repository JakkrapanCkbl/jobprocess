				...
				<div class="card-body">
					...
					<form action="{{route('admininputjob.update2',[$job->id])}}" method="POST" enctype="multipart/form-data">@csrf
						...
						<div class="form-group">
							...
							<input type="text" name="landsize" class="form-control{{ $errors->has('landsize') ? ' is-invalid' : '' }}" value="{{ $job->landsize }}">
						...
						<div class="form-group">
							...
							<input type="text" name="startprice" class="form-control{{ $errors->has('startprice') ? ' is-invalid' : '' }}" value="{{ $job->startprice }}">
						...
						<div class="form-group">
							...
							<input type="text" name="convenient" class="form-control{{ $errors->has('convenient') ? ' is-invalid' : '' }}" value="{{ $job->convenient }}">
						...
						<div class="form-group">
							...
							<input type="text" name="broker" class="form-control{{ $errors->has('broker') ? ' is-invalid' : '' }}" value="{{ $job->broker }}">
						...
						<div class="form-group">
							...
							<input type="text" name="buildingprogress" class="form-control{{ $errors->has('buildingprogress') ? ' is-invalid' : '' }}" value="{{ $job->buildingprogress }}">
						...
						<div class="form-group">
							...
							<input type="text" name="lat" class="form-control{{ $errors->has('lat') ? ' is-invalid' : '' }}" value="{{ $job->lat }}">
							@if ($errors->has('lat'))
							<span class="invalid-feedback" role="alert">
						...
						<div class="form-group">
							...
							<input type="text" name="lng" class="form-control{{ $errors->has('lng') ? ' is-invalid' : '' }}" value="{{ $job->lng }}">
							@if ($errors->has('lng'))
							<span class="invalid-feedback" role="alert">
						...
						<div class="form-group">
							...
							<input type="text" name="inforesource" class="form-control{{ $errors->has('inforesource') ? ' is-invalid' : '' }}" value="{{ $job->inforesource }}">
						...
						<div class="form-group">
							...
							<input type="text" name="assessmentvalue" class="form-control{{ $errors->has('assessmentvalue') ? ' is-invalid' : '' }}" value="{{ $job->assessmentvalue }}">
