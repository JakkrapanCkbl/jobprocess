            ...
            <div class="card-body" style="background-color: #f8ede4;">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="input-group">
                                <input type="text" name="govprice_row1a" class="form-control{{ $errors->has('roomarea') ? ' is-invalid' : '' }}" value="{{ $job->roomarea }}">
                                <div class="input-group-append">
                                    <div class="input-group-text">
                                        <p>ตร.ม.</p>
                                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="input-group">
                                <input type="text" name="govprice_row2a" class="form-control{{ $errors->has('room_indoor_area') ? ' is-invalid' : '' }}" value="{{ $job->room_indoor_area }}">
                                <div class="input-group-append">
                                    <div class="input-group-text">
                                        <p>ตร.ม.</p>
                                    </div>
                        ...
                        <div class="col-md-2">
                            <input type="text" name="govprice_row2b" class="form-control{{ $errors->has('room_indoor_price') ? ' is-invalid' : '' }}" value="{{ $job->room_indoor_price }}">
                        </div>
                        <div class="col-md-2">
                            <input type="text" name="govprice_row2c" class="form-control{{ $errors->has('govprice_row2c') ? ' is-invalid' : '' }}" disabled>
                        </div>
                        <div class="col-md-3">
                            <input type="text" name="govprice_row2d" class="form-control{{ $errors->has('room_indoor_gov_price') ? ' is-invalid' : '' }}" value="{{ $job->room_indoor_gov_price }}">
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="input-group">
                                <input type="text" name="govprice_row3a" class="form-control{{ $errors->has('room_balcony_area') ? ' is-invalid' : '' }}" value="{{ $job->room_balcony_area }}">
                                <div class="input-group-append">
                                    <div class="input-group-text">
                                        <p>ตร.ม.</p>
                                    </div>
                        ...
                        <div class="col-md-2">
                            <input type="text" name="govprice_row3b" class="form-control{{ $errors->has('room_balcony_price') ? ' is-invalid' : '' }}" value="{{ $job->room_balcony_price }}">
                        </div>
                        <div class="col-md-2">
                            <input type="text" name="govprice_row3c" class="form-control{{ $errors->has('govprice_row3c') ? ' is-invalid' : '' }}" disabled>
                        </div>
                        <div class="col-md-3">
                            <input type="text" name="govprice_row3d" class="form-control{{ $errors->has('room_balcony_gov_price	') ? ' is-invalid' : '' }}" value="{{ $job->room_balcony_gov_price	 }}">
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="input-group">
                                <input type="text" name="govprice_row4a" class="form-control{{ $errors->has('room_parking_area') ? ' is-invalid' : '' }}" value="{{ $job->room_parking_area }}">
                                <div class="input-group-append">
                                    <div class="input-group-text">
                                        <p>ตร.ม.</p>
                                    </div>
                        ...
                        <div class="col-md-2">
                            <input type="text" name="govprice_row4c" class="form-control{{ $errors->has('room_parking_price') ? ' is-invalid' : '' }}" value="{{ $job->room_parking_price }}">
                        </div>
                        <div class="col-md-3">
                            <input type="text" name="govprice_row4d" class="form-control{{ $errors->has('room_parking_gov_price') ? ' is-invalid' : '' }}" value="{{ $job->room_parking_gov_price }}">
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <input type="text" name="govprice_row5a" class="form-control{{ $errors->has('room_total_gov_price') ? ' is-invalid' : '' }}" value="{{ $job->room_total_gov_price }}">
                        </div>
                    </div>
                </div>
