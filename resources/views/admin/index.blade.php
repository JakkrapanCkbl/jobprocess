                ...
                <tbody> 
                  @foreach($jobs as $job)         
                    <tr>
                      ...
                      <td>
                        <a href="{{route('admininputjob.edit',[$job->id])}}"><button style="width:70px" class="btn btn-primary">Edit</button></a>
                        <!-- Delete Button trigger modal -->
                        <button style="width:70px" type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal{{$job->id}}">Delete</button>
                        <!-- Modal -->
