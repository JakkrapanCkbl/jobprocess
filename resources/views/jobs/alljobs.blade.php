     ...
     <div class="rounded border jobs-wrap">
        ...
        <div class="job-details h-100">
            ...
            <div class="d-flex row justify-content-center justify-content-md-start">
                ...
                <div class="mr-3"><span class="fas fa-money-bill-alt text-primary"></span>&nbsp;{{$job->eva_price_m2}} บาท/ตร.ม.</div>
            ...
            <div class="job-category align-self-center">
                ...
                @elseif($job->percentfinish == 0)
                    ...
                    <span class="badge badge-pill badge-danger">
                        &nbsp;&nbsp;%&nbsp;<a href="javascript:void(0)" class="mr-3" title="" data-original-title="Normal" data-toggle="modal" data-target="#progressModal{{$job->id}}"><i class="fe fe-edit-2 text-dark fs-16"></i></a>
                    </span>                
                @else
                    <br>
                    <span class="badge badge-pill badge-danger">
