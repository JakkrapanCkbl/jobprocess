	...
	<body>
		...
		<div class="page custom-pages">
			<div class="container text-center">
				...
				<p class="h5 font-weight-normal mb-7 leading-normal">Sorry, an error has occured, Requested page not found!</p>
				<a class="btn btn-primary" href="index.html"><i class="fe fe-chevrons-left"></i> Back To Home </a>
			</div>
		</div>
		...
		<script src="<?php echo e(asset('external2/js/vendors/selectize.min.js')); ?>"></script>
		<script src="<?php echo e(asset('external2/js/vendors/jquery.tablesorter.min.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\jobprocess\resources\views/dashboard/400.blade.php ENDPATH**/ ?>