		...
		<div class="page">
			<div class="page-main">
				...
				<div class="container content-area">
					...
					<!-- Tab -->
						<?php echo $__env->make('report.tab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>				
					<!-- End Tab -->

				

		<?php echo $__env->make('report.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	<?php /**PATH C:\xampp\htdocs\jobprocess\resources\views/report/edit.blade.php ENDPATH**/ ?>