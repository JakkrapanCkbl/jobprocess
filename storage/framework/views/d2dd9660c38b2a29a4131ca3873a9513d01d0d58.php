              ...
              <div class="job-details h-100">
                <div class="p-3 align-self-center">
                  ...
                  <div class="row d-flex justify-content-center justify-content-md-start">
                    ...
                    <div class="mr-2 mb-1"><span class="text-info p-1 rounded border border-info"><?php echo e($job->client); ?></span></div>
                  ...
                  <div class="d-flex row justify-content-center justify-content-md-start">
                    <div class="mr-2"><span class="fas fa-th-large text-primary"></span>&nbsp;<?php echo e($job->prop_size); ?> </div>
                  ...
                  <div class="d-flex row justify-content-center justify-content-md-start">
                    ...
                    <div class="fa-icon" id="fa-invoice<?php echo e($job->id); ?>"><span class="fas fa-file-invoice" alt="ใบแจ้งหนี้" title="ใบแจ้งหนี้"></div>
                    <div class="fa-icon" id="fa-receipt<?php echo e($job->id); ?>"><span class="fas fa-file-invoice-dollar" alt="ใบเสร็จรับเงิน" title="ใบเสร็จรับเงิน"></div>
                    <div class="fa-icon-inrow" id="fa-ope<?php echo e($job->id); ?>"><span class="fas fa-donate" alt="OPE" title="OPE"></div>
                  </div>
...
</html><?php /**PATH C:\xampp\htdocs\jobprocess\resources\views/welcome.blade.php ENDPATH**/ ?>