			...
			<div class="page-main">
				...
				<aside class="app-sidebar">
					<div class="app-sidebar__user">
						<div class="user-body">
							<span class="avatar avatar-lg brround text-center cover-image" data-image-src="<?php echo e(asset(Auth::user()->avatar)); ?>"></span>
						</div>
						<div class="user-info">
