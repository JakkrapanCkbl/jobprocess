<!-- Horizontal-Menu -->
								...
								<ul class="horizontalMenu-list">
									...
									<li aria-haspopup="true"><a href="#" class="sub-icon"><i class="fe fe-pie-chart"></i> Jobs  <i class="fa fa-angle-down horizontal-icon"></i></a>
										<ul class="sub-menu">
											<li aria-haspopup="true">
												<a href="<?php echo e(route('admininputjob.create')); ?>">Assign Job</a>
									...
									<li aria-haspopup="true"><a href="#" class="sub-icon"><i class="fe fe-layers"></i>Admin <i class="fa fa-angle-down horizontal-icon"></i></a>
										<ul class="sub-menu">
											...
											<li aria-haspopup="true"><a href="<?php echo e(route('invoice')); ?>">Invoice / Receive</a></li>
				...
				<!-- Horizontal-Menu End --><?php /**PATH C:\xampp\htdocs\jobprocess\resources\views/invoice/menubar.blade.php ENDPATH**/ ?>