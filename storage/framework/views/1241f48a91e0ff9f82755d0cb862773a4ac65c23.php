		...
		<div class="page">
			<div class="page-main">
				...
				<div class="container content-area">
					...
					<!-- Tab -->
						<?php echo $__env->make('invoice.tab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>				
					<!-- End Tab -->

				

		<?php echo $__env->make('invoice.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	<?php /**PATH C:\xampp\htdocs\jobprocess\resources\views/invoice/edit.blade.php ENDPATH**/ ?>